<?php
	...
	$jml_data = mysql_num_rows(mysql_query("select * from permintaan"));
	...
	if(isset($_GET['hal'])){
			...
			$s = mysql_query("select * from permintaan order by  	id_permintaan  desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = mysql_query("select * from permintaan order by  	id_permintaan desc limit 0, $jml_per_halaman")
				or die(mysql_error());
	}
?>
...
<head>
	<meta charset="utf-8">
	<title>Managemen Permintaan</title>
			...
			<div>
                ...
                <div style="margin-top:10px">
                    ...
                    <thead>
                        ...
                        <td width="10%"><font face="Comic Sans MS, cursive" class="text-error text-center"><h5>Keterangan Permintaan</h5></font></td>
                    ...
                    <?php 
						while($data=mysql_fetch_array($s)){
							...
							$kode=$data['id_permintaan'];
							$nama=$data['nama'];
							$email=$data['keterangan'];
                    ...
                    <tbody>
                        ...
                        <td>
                        	<font face="Comic Sans MS, cursive" class="text-info text-center"><h5>
                                ...
                                <a class="btn btn-small btn-warning" href="permintaan_delete.php?kode=<?php echo $kode;?>" data-toggle="tooltip" data-placement="bottom"
                                    title="Hapus">Hapus</a>
							</h5></font>
						</td>
                    </tbody>
