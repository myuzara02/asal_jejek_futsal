...
<h2>Pembayaran</h2>		
  ...
  <tr>
    <th>No</th><th>ID Pemesanan</th><th>Tgl Pesan</th><th>Nama Lapangan</th><th>Tgl Main</th><th>Lama Sewa</th><th>Jam Mulai</th><th>Jam Habis</th><th>Harga</th><th>Total Harga</th><th>Bukti</th><th>Konfirmasi</th><th>Aksi</th>
  </tr>
  <?php
...
$no=1; 
 ...
 $jhab=substr("$d[jhabis]",11,5);
  ...
  echo"
  <tr>
	<td>$no</td><td>$d[idsewa]</td><td>$d[tgl_pesan]</td><td>$lap[nm]</td><td>$tg</td><td>$d[lama] jam</td><td>$jmul</td><td>$jhab</td>";?><td><?php echo "Rp. ".number_format($d[harga]).",- ($d[jns])"?></td><td><?php echo "Rp. ".number_format($d[tot]).",-"?></td><?php echo"<td>$bukti</td><td>$konfirmasi</td><td>$bayar $cetak</td>
  </tr>";
  $no++;
  }
  ?>
...
<tr><td>  Bukti Transfer </td><td><input type=file name='fupload'  class='form-control'></td></tr>
						
		   <tr><td colspan=2><input type=submit value=Kirim class='btn btn-primary'>
